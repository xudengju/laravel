   ...
   <div class="regist">
        <div class="regist_center">
            <div class="regist_top">
                ...
                <div class="right fr"><a href="{{url('user/emailRegister')}}" target="_self">邮箱注册</a> <a href="{{url('index/index')}}" target="_self">小米商城</a></div>
                <div class="clear"></div>
            ...
            <div class="regist_main center">
                ...
                <div class="username">手&nbsp;&nbsp;机&nbsp;&nbsp;号:&nbsp;&nbsp;<input class="shurukuang" id="telephone" type="text" name="tel" placeholder="请填写正确的手机号"/><span id="telephone_span">手机号要输对，方便我们联系你</span></div>
                <div class="username">
