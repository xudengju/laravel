...
<form  method="post" action="/index.php/login" class="form center">
    <div class="login">
        <div class="login_center">
            <div class="login_top">
                <div class="left fl">会员登录</div>
                <div class="right fr">您还不是我们的会员？<a href="{{url('user/emailLogin')}}">邮箱登录</a> <a href="{{url('user/register')}}" target="_self">立即注册</a></div>
                <div class="clear"></div>
                <div class="xian center"></div>
            </div>
            @csrf
            <div class="login_main center">
                <div class="username">手机号:&nbsp;<input class="shurukuang" type="text" name="tel" placeholder="请输入你的手机号"/></div>
