...
<header>
    <div class="top center">
        ...
        <div class="right fr">
            <div class="gouwuche fr"><a href="{{url('goods/order')}}">我的订单</a></div>
            <div class="fr">
                <ul>
...
<div class="grzxbj">
    <div class="selfinfo center">
        <div class="lfnav fl">
            ...
            <div class="subddzx">
                <ul>
                    <li><a href="{{url('goods/order')}}" >我的订单</a></li>
                    <li><a href="">意外保</a></li>
                    <li><a href="">团购订单</a></li>
                    <li><a href="">评价晒单</a></li>
                </ul>
            ...
            <div class="subddzx">
                <ul>
                    <li><a href="{{url('user/userInfo')}}" style="color:#ff6700;font-weight:bold;">我的个人中心</a></li>
                    <li><a href="">消息通知</a></li>
                    <li><a href="">优惠券</a></li>
                    <li><a href="">收货地址</a></li>
                </ul>
